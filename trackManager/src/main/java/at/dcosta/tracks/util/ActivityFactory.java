...
public class ActivityFactory {
	...
	public ActivityFactory(Context context) {
		...
		registerActivity(R.string.activity_climbing, R.drawable.climbing, Color.parseColor("#F3F781"), Validators.CLIMBING);
		registerActivity(R.string.activity_hiking, R.drawable.hiking, Color.parseColor("#F7FE2E"), Validators.HIKE);
		registerActivity(R.string.activity_mountainbiking, R.drawable.mountainbiking, Color.parseColor("#31B404"), Validators.BIKE);
		registerActivity(R.string.activity_biking, R.drawable.biking, Color.parseColor("#088A08"), Validators.BIKE);
		registerActivity(R.string.activity_bike_and_hike, R.drawable.bikeandhike, Color.parseColor("#64FE2E"), Validators.BIKE);
		registerActivity(R.string.activity_running, R.drawable.running, Color.parseColor("#31B404"), Validators.HIKE);
		registerActivity(R.string.activity_skiing, R.drawable.skiing, Color.parseColor("#58FAF4"), Validators.SKITOUR);
		registerActivity(R.string.activity_figln, R.drawable.figln, Color.parseColor("#58FAF4"), Validators.SKITOUR);
		registerActivity(R.string.activity_skitour, R.drawable.skitour, Color.parseColor("#0404B4"), Validators.SKITOUR);
		registerActivity(R.string.activity_sledging, R.drawable.sledging, Color.parseColor("#2E9AFE"), Validators.SLEDGE);
	}
	...
	public TrackActivity fromIcon(String icon, TrackActivity defaultActivity) {
		...
		TrackActivity tourActivity = activitiesByIconId.get(icon);
		...
		if (!activitiesByActivity.containsKey(nameId)) {
			synchronized (this) {
				if (!activitiesByActivity.containsKey(nameId)) {
					...
					activitiesByIconId.put(icon, activity);
				}
			}
		}
	}
