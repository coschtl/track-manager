...
public class TrackDescription implements Serializable {
	...
	private double hotizontalDistance;
	...
	public TrackDescription(long id, String name, String path, long startEpochSecs, long endEpochSecs, int movingTimeSeconds, double hotizontalDistance,
			int verticalUp, ActivityFactory activityFactory) {
		this.id = id;
		...
		this.hotizontalDistance = hotizontalDistance;
	...
	public TrackDescription(String name, String path, TrackStatistic statistic, ActivityFactory activityFactory) {
		id = -1;
		this.name = name;
		this.path = path;
		this.activityFactory = activityFactory;
	...
	public TrackDescription addMultiValueExtra(String name, String value) {
	...
	public double getHotizontalDistance() {
		return hotizontalDistance;
	}
	...
	public TrackDescription setMultiValueExtra(String name, List<String> values) {
	...
	public TrackDescription setSingleValueExtra(String name, String value) {
	...
	public IconListBean toIconListBean(long id) {
		...
		if (extraPhotos != null && extraPhotos.size() > 0) {
			bean.setExtra(IconListBean.KEY_ADDITIONAL_ICON, at.dcosta.tracks.R.drawable.camera);
		}
		return bean;
	}
	...
	public void updateStatistic(TrackStatistic statistic) {
		...
		hotizontalDistance = totalDistance.getHorizontal();
