...
public class RecordTrackOsm extends MapsActivity implements OnClickListener, OnLongClickListener, LocationListener {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case TrackerService.MSG_GET_TRACK:
					...
					RecordTrackOsm recordTrack = reference.get();
	...
	private void setGpsIcon() {
		gpsButton.setImageResource(TrackerStatus.connected ? R.drawable.satellite_active : R.drawable.satellite);
		gpsButton.invalidate();
	}

	private void setPlayStopIcon() {
		playStopButton.setImageResource(TrackerStatus.recording ? R.drawable.stop : R.drawable.play);
		playStopButton.invalidate();
	}

	private void setSendIcon() {
		sendButton.setImageResource(TrackerStatus.sending ? R.drawable.wifi_active : R.drawable.wifi);
