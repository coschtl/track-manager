...
public class TrackCopy extends Activity implements OnClickListener {
	...
	private static class MyDatePickerDialog extends DatePickerDialog {
		...
		public MyDatePickerDialog(Context context, final EditText text) {
	...
	public static void copyTrack(TrackDescription origTrack, List<Point> trackOrig, String newName, long timeDiffMillis, TrackDbAdapter trackDbAdapter)
		...
		TrackDescription copyEntry = trackDbAdapter.fetchEntry(copyId);
	...
	private TrackDescription origTrack;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		origTrack = trackDbAdapter.fetchEntry(extras.getLong(TrackDescription.KEY_ID));
	...
	protected Dialog onCreateDialog(int id) {
		switch (id) {
			case DATE_DIALOG_ID:
				return new MyDatePickerDialog(this, date);
			case TIME_DIALOG_ID:
				final Calendar c = Calendar.getInstance();
